...
var Game = function(container) {
  ...
  this.pauseListenerEnabled = true;
...
Game.prototype = {
  ...
  /**
   * Запрет/разрешение на использование pauseListener
   * @param {boolean} enable
   */
  enablePauseListener: function(flag) {
    this.pauseListenerEnabled = flag;
  },
  ...
  _pauseListener: function(evt) {
    if (this.pauseListenerEnabled && evt.keyCode === 32) {
      evt.preventDefault();
